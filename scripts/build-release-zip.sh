...
COMPOSER_INSTALL_EXTRA_ARGS="${COMPOSER_INSTALL_EXTRA_ARGS:-}"
...
composer --working-dir="$PLUGIN_STAGE" install --no-dev --no-interaction --prefer-dist --optimize-autoloader $COMPOSER_INSTALL_EXTRA_ARGS
