            ...
            <div className="entity-wrapper channel-wrapper">
                                ...
                                <>
                                    {availableBots.length > 0 ? (
                                        <Select
                                            ...
                                            isSearchable={false}
                                            placeholder={wp.i18n.__( 'Pick a VK bot', 'cf7-vk' )}
                                            onChange={handleBotSelect}
                                            isClearable
                                        />
                                    ) : (
                                        <span className="no-bots-found">
                                            [{wp.i18n.__( 'No VK bots available', 'cf7-vk' )}]
                                        </span>
                                    )}
                                </>
                            )}
                ...
                <div className="frame chats">
                    {renderedChats.length > 0 ? (
                        ...
                        <span className="no-chats-found">[{wp.i18n.__( 'No dialogs assigned to this channel', 'cf7-vk' )}]</span>
                    )}
                </div>
                ...
                <div className="frame forms">
                    <button className="add-button add-form-button" type="button" onClick={handleAddForm}>
                        {!showFormSelector
                            ? wp.i18n.__( 'Add Form', 'cf7-vk' )
                            : wp.i18n.__( 'Cancel', 'cf7-vk' )}
                    </button>
                    ...
                    {showFormSelector ? (
                        <Select
                            ...
                            isSearchable={true}
                            placeholder={wp.i18n.__( 'Pick a form', 'cf7-vk' )}
                    ...
                    {formsForChannel.length > 0 ? (
                        ...
                        <span className="no-forms-found">[{wp.i18n.__( 'No forms assigned to this channel', 'cf7-vk' )}]</span>
                    ) : null}
                </div>
